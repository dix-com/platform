                            ...
                            <div className="profile-summary truncate">
                                {profileUser ? (
                                    <>
                                        ...
                                        {currentTab === "crits" && <p>{profileUser.critCount || 0} Crits</p>}
                                        {currentTab === "replies" && <p>{profileUser.critCount || 0} Crits</p>}
                                ...
                                <>
                                    ...
                                    <section className="crits">
                                        ...
                                        >
                                            <TabPanel name="crits">
                                                {profileUser?.pin && (
                                                    <CritPreview crit={profileUser.pin} pin={true} />
                                                )}

                                                <PaginatedList
                                                    queryHook={useGetUserCritsQuery}
                                                    ...
                                                    renderPlaceholder={() => (
                                                        <Placeholder
                                                            title={`@${username} hasn't posted any crits`}
                                                            subtitle="Once they do, those crits will show up here."
                                                        />
                                                    )}
                                                />
                                            </TabPanel>
