...
const Profile = () => {
    ...
    const { isCurrentUser, profileUser, isProfileLoading } = useGetUserInfoQuery(username, {
                    ...
                    <>
                        <ColumnHeader routerBack={true}>
                            <div className="profile-summary">
                                ...
                                {!!tabData?.length && <p>{tabData.length} Crits</p>}
                                {/* {currentTab === "crits" && <p>{crits.length} Crits</p>}
                                {currentTab === "replies" && <p>{replies.length} Crits</p>}
