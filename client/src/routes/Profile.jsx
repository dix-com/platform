...
import { useGetUserInfoQuery, useGetUserCritsQuery } from "../store/api/userApi";

import usePagination from "../hooks/usePagination";
import { formatDate } from "../helpers/date";

const Profile = () => {
    const [tab, setTab] = useState("Crits");
    ...
    const {
        data: crits,
        isLoading: critsLoading,
        lastElementRef,
    } = usePagination(useGetUserCritsQuery, { identifier: username });
                    ...
                    <>
                        <ColumnHeader routerBack={true}>
                            <div className="profile-summary">
                                ...
                                {tab === "Crits" && <p>{profileUser.critsCount} Crits</p>}
                                {tab === "Replies" && <p>{profileUser.critsCount} Crits</p>}
