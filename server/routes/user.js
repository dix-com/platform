...
router.post("/:userId/pin/:critId", userController.pinCrit);
...
router.delete("/:userId/bookmarks/:critId", bookmarkController.deleteBookmark);

router.delete("/:userId/bookmarks", bookmarkController.deleteAllBookmarks);

router.delete("/:userId/pin/:critId", userController.unpinCrit);
